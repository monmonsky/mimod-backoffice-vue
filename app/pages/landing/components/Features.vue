...
<template>
    <div class="container py-8 md:py-12 xl:py-16 2xl:py-24">
        <div class="text-center">
            <div class="rounded-box inline-flex items-center border border-indigo-500/10 bg-indigo-500/5 p-2">
        ...
        <div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:mt-16 xl:grid-cols-4 2xl:mt-24 2xl:gap-6">
            <div
                ...
                :key="index"
                class="card border-base-300 cursor-pointer border border-dashed transition-all duration-300"
                :class="feature.cardClass">
                <div class="card-body">
                    <div>
                        <div class="rounded-box inline-flex items-center p-2" :class="feature.iconClass">
                            <span class="iconify" :class="`${feature.icon} size-6`" />
                        </div>
