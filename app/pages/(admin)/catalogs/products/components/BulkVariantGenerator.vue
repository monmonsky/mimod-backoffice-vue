...
const generateVariants = () => {
    ...
    const variants = valueCombinations.map((combination: any, index: number) => {
        // Generate SKU suggestion (you can customize this)
        const skuParts = combination.map((v: any) => v.slug.toUpperCase().replace(/-/g, ''));
        const sku = `${props.productName.substring(0, 3).toUpperCase()}-${skuParts.join('-')}`;
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                        <div class="space-y-2">
                            ...
                            <div class="join w-full">
                                ...
                                />
                                <button class="btn btn-sm join-item" @click="applyBulkUpdate('price')">
                                    Apply
                                </button>
                            </div>
                        </div>
                        <div class="space-y-2">
                            ...
                            <div class="join w-full">
                                <input
                                    ...
                                    class="input input-sm join-item w-full"
                                />
                                <button class="btn btn-sm join-item" @click="applyBulkUpdate('compare_at_price')">
                                    Apply
                                </button>
                            </div>
                        </div>
                        <div class="space-y-2">
                            ...
                            <div class="join w-full">
                                <input
                                    ...
                                    class="input input-sm join-item w-full"
                                />
                                <button class="btn btn-sm join-item" @click="applyBulkUpdate('stock_quantity')">
                                    Apply
                                </button>
                            </div>
                        </div>
                        <div class="space-y-2">
                            ...
                            <div class="join w-full">
                                <input
                                    ...
                                    class="input input-sm join-item w-full"
                                />
                                <button class="btn btn-sm join-item" @click="applyBulkUpdate('weight_gram')">
                                    Apply
                                </button>
                            </div>
                        </div>
