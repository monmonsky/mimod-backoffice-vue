...
export function flexRender<TProps extends object, TResult>(
    renderable: TResult | ((props: TProps) => TResult),
    props: TProps,
): unknown {
    return typeof renderable === "function" ? (renderable as (props: TProps) => TResult)(props) : renderable;
}
